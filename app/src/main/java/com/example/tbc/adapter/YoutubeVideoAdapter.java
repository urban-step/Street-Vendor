...
public class YoutubeVideoAdapter extends RecyclerView.Adapter<YoutubeViewHolder> {
    ...
    public void onBindViewHolder(YoutubeViewHolder holder, final int position) {
        ...
        holder.videoThumbnailImageView.setImageResource(R.drawable.placeholder);


        /*  initialize the thumbnail image view , we need to pass Developer Key */
        holder.videoThumbnailImageView.initialize(AppSharedPrefernce.getInstance().DEVELOPER_KEY, new YouTubeThumbnailView.OnInitializedListener() {
            @Override
